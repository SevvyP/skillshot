...
2. **Configure environment**
   ...
   - Gemini API (optional): Get key at [makersuite.google.com](https://makersuite.google.com/app/apikey)
...
- Verify tags are generated automatically (when Gemini API configured)
